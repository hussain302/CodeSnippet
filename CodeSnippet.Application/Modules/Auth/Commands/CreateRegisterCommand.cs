...
namespace CodeSnippet.Application.Modules.Auth.Commands;
public partial record CreateRegisterCommand(string Username, string FirstName, string MiddleName, 
    string LastName, string Password, string Email, RoleDto Role, Address Address) : ICommand<Guid>
{
